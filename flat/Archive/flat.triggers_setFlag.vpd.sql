...
BEGIN
    FOR r IN (SELECT collection_object_id FROM flat WHERE stale_flag = 1 AND ROWNUM<5000) LOOP
...
-- replaces ti_flat_catitem which is the same code.
...
/* replaced by tr_catitem_flat_au
...
-- replaces a_flat_catitem and tu_flat_catitem.
