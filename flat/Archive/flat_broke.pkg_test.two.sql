...
begin
	update flat set (
    	...
    	infraspecific_rank
	 	...
	 	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'full_taxon_name')
    	else
    		taxonomy.full_taxon_name
    	end,
        case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'phylclass')
    	else
    		taxonomy.phylclass
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Kingdom')
    	else
    		taxonomy.Kingdom
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Phylum')
    	else
    		taxonomy.Phylum
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'phylOrder')
    	else
    		taxonomy.phylOrder
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Family')
    	else
    		taxonomy.Family
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Genus')
    	else
    		taxonomy.Genus
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Species')
    	else
    		taxonomy.Species
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'Subspecies')
    	else
    		taxonomy.Subspecies
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'author_text')
    	else
    		taxonomy.author_text
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'nomenclatural_code')
    	else
    		taxonomy.nomenclatural_code
    	end,
    	case when identification.TAXA_FORMULA like '%B' then 
    		get_taxonomy(identification.collection_object_id,'infraspecific_rank')
    	else
    		taxonomy.infraspecific_rank
    	end
    FROM
    ...
    WHERE
    	...
    	identification.identification_id = identification_taxonomy.identification_id and
    	identification_taxonomy.taxon_name_id = taxonomy.taxon_name_id and
    	flat.collection_object_id = flat_is_broken.collection_object_id and
    	problem='bad taxonomy' and
    	fixed is null
    )
    ;
    update flat_is_broken set fixed=1 where problem='bad taxonomy';
end;
------------------------------------------------------------------------------------------
