...
DECLARE
BEGIN
    FOR index_entry IN (select INDEX_NAME from user_indexes where  table_name='FLAT' 
...
ALTER INDEX IX_F_TXT_TLOC_SRCH_TRMS REBUILD;
ALTER INDEX IX_FLAT_CATNUM REBUILD;
ALTER INDEX PK_FLAT REBUILD;
ALTER INDEX IX_FLAT_FEATURE_UPR REBUILD;
ALTER INDEX IX_FLAT_COUNTY_UPR REBUILD;
ALTER INDEX IX_FLAT_COUNTRY_UPR REBUILD;
ALTER INDEX IX_FLAT_CONTINENTOCEAN_UPR REBUILD;
ALTER INDEX IX_FLAT_GUID REBUILD;
ALTER INDEX FLAT_SPEC_LOC REBUILD;
ALTER INDEX FLAT_DEC_LONG REBUILD;
ALTER INDEX FLAT_DEC_LAT REBUILD;
ALTER INDEX FLAT_COUNTRY REBUILD;
ALTER INDEX IX_U_FLAT_ACCN REBUILD;
ALTER INDEX IX_FLAT_LOCALITYID REBUILD;
ALTER INDEX IX_FLAT_COLLEVENTID REBUILD;
ALTER INDEX IX_FLAT_STALEFLAG REBUILD;
ALTER INDEX IX_FLAT_IDENTIFICATIONID REBUILD;
ALTER INDEX IX_FLAT_U_CATNUM REBUILD;
ALTER INDEX IX_FLAT_COLLECTORS REBUILD;
ALTER INDEX IX_FLAT_COLLECTIONID REBUILD;
ALTER INDEX IX_FLAT_HASTISSUES REBUILD;
ALTER INDEX IX_U_FLAT_ACCNID REBUILD;
ALTER INDEX IX_FLAT_GEOGAUTHRECID REBUILD;
ALTER INDEX IX_FLAT_DAY REBUILD;
ALTER INDEX IX_FLAT_MONTH REBUILD;
ALTER INDEX IX_FLAT_U_CLASS REBUILD;
ALTER INDEX IX_FLAT_U_PHYLUM REBUILD;
ALTER INDEX IX_FLAT_U_KINGDOM REBUILD;
ALTER INDEX IX_FLAT_U_PORDER REBUILD;
ALTER INDEX IX_FLAT_YEAR REBUILD;
ALTER INDEX IU_FLAT_GUID_UPR REBUILD;
ALTER INDEX IX_FLAT_TYPESTATUS_UPR REBUILD;
ALTER INDEX IX_FLAT_STATEPROV_UPR REBUILD;
ALTER INDEX IX_FLAT_SEA_UPR REBUILD;
ALTER INDEX IX_FLAT_SCIENTIFICNAME_UPR REBUILD;
ALTER INDEX IX_FLAT_QUAD_UPR REBUILD;
ALTER INDEX IX_FLAT_PARTS_UPR REBUILD;
ALTER INDEX IX_FLAT_ISLANDGROUP_UPR REBUILD;
ALTER INDEX IX_FLAT_ISLAND_UPR REBUILD;
ALTER INDEX IX_FLAT_HIGHER_GEOG_UPR REBUILD;
ALTER INDEX IX_UPR_FLAT_ACCN REBUILD;
ALTER INDEX IX_FLAT_SCIENTIFICNAME REBUILD;
ALTER INDEX IX_F_LOC_SRCH_TRM REBUILD;
ALTER INDEX IX_FLAT_U_GENUS REBUILD;
ALTER INDEX IX_FLAT_U_FAMILY REBUILD;
