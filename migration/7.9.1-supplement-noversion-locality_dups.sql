...
BEGIN
	...
	for r in (
		select * from locality where LOCALITY_NAME is null and rownum<20 and (last_dup_check_date is null or sysdate-last_dup_check_date > 30) order by last_dup_check_date desc
	) loop
