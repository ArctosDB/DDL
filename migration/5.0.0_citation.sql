...
-------------
alter trigger TR_CITATION_AIUD_FLAT disable;
...
UPDATE citation SET OCCURS_PAGE_NUMBER=NULL WHERE OCCURS_PAGE_NUMBER=0;


alter trigger TR_CITATION_AIUD_FLAT enable;
	    
UPDATE flat set stale_flag = 1 WHERE collection_object_id IN (SELECT collection_object_id FROM citation WHERE ROWNUM<100000);
