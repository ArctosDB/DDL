	...
	BEGIN
		...
		if l_locality_id is null then
	        ...
	        ELSE
				...
				if geology_attribute_1 is not null or geology_attribute_2 is not null or geology_attribute_3 is not null or
					geology_attribute_4 is not null or geology_attribute_5 is not null or geology_attribute_6 is not null then
					-- grab a temp key
					select somerandomsequence.nextval into n from dual;
					if geology_attribute_1 is not null then
					...
					if geology_attribute_2 is not null then
						insert into bl_geology_attributes (
							GEOLOGY_ATTRIBUTE,
							GEO_ATT_VALUE,
							GEO_ATT_DETERMINED_DATE,
					...
					if geology_attribute_3 is not null then
						insert into bl_geology_attributes (
							GEOLOGY_ATTRIBUTE,
							GEO_ATT_VALUE,
							GEO_ATT_DETERMINED_DATE,
					...
					if geology_attribute_4 is not null then
						insert into bl_geology_attributes (
							GEOLOGY_ATTRIBUTE,
							GEO_ATT_VALUE,
							GEO_ATT_DETERMINED_DATE,
					...
					if geology_attribute_5 is not null then
						insert into bl_geology_attributes (
							GEOLOGY_ATTRIBUTE,
							GEO_ATT_VALUE,
							GEO_ATT_DETERMINED_DATE,
					...
					if geology_attribute_6 is not null then
						insert into bl_geology_attributes (
							GEOLOGY_ATTRIBUTE,
							GEO_ATT_VALUE,
							GEO_ATT_DETERMINED_DATE,
