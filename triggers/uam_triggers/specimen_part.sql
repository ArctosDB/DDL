...
TRIGGER_NAME
------------------------------------------------------------------------------------------
MAKE_PART_COLL_OBJ_CONT
TR_SPECPART_AIUD_FLAT
SPECIMEN_PART_CT_CHECK

DROP TRIGGER TRG_SPECIMENPART_DELETE;
DROP TRIGGER MAKE_PART_COLL_OBJ_CONT;
DROP TRIGGER TR_SPECPART_AIUD_FLAT;
DROP TRIGGER SPECIMEN_PART_CT_CHECK;
DROP TRIGGER trg_specimenpart_delete_xx;


DROP TRIGGER TR_COLLOBJCONTHIST_AD;
